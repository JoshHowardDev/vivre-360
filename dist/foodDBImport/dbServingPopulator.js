...
function transferFoodsToDB() {
    return __awaiter(this, void 0, void 0, function () {
        var usdaData, foodsArray, usdaStatusObj, lastIdAdded, transferQuantity, queryString, queryValue, queryParams, _loop_1, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, readAndParse('usdaStatus')];
                case 2:
                    usdaStatusObj = _a.sent();
                    lastIdAdded = usdaStatusObj.lastIdAdded;
                    transferQuantity = 93;
                    queryString = 'INSERT INTO servings (food_id, name, gramWeight) VALUES ';
                    queryValue = 1;
                    queryParams = [];
                    _loop_1 = function (i) {
                        ...
                        if (foodsArray[i] && foodsArray[i].foodPortions) {
                            foodsArray[i].foodPortions.forEach(function (portion) {
                                queryString += "($".concat(queryValue++, ", $").concat(queryValue++, ", $").concat(queryValue++, "), ");
                    ...
                    queryString = "".concat(queryString.slice(0, -2), ";");
                    db.query(queryString, queryParams);
                    usdaStatusObj.lastIdAdded += transferQuantity;
                    return [4 /*yield*/, fs.writeFile(path.resolve(__dirname, './usdaStatus.json'), JSON.stringify(usdaStatusObj))];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
