const nutrientReference = {
  ...
  b9: { units: 'ug', type: 'vitamin', displayName: 'Folate (B9)' },
  b12: { units: 'ug', type: 'vitamin', displayName: 'Vitamin B12' },
  ...
  k: { units: 'ug', type: 'vitamin', displayName: 'Vitamin K' },
  ...
  selenium: { units: 'ug', type: 'mineral', displayName: 'Selenium' },
